...
if __name__ == '__main__':
    ...
    parser.add_argument('--hidden-size',type=int, help="size od hidden dimension",default=128)
    ...
    config = {'vocab_size': vocab_size,"batch_size":args.batch_size, 'embed_dim': args.embed_dim, 'training': True, 'hidden_size': args.hidden_size}
    ### TODO(Students END
